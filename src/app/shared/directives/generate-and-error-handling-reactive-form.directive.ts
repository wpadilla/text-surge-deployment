    ...
    if (updatedControlName) {
      ...
      if (control.errors) {
        ...
        Object.keys(control.errors).forEach(errorType => {
          ...
          // overwritten the error message if the control has other message assigned
          errorMessage = controlElement.getAttribute('data-error-message') || errorMessage;
          ...
          if (handleOnBlur) {
            ...
            if (this.isErrrorMessagePainted(errorMessageClass)) {
              return;
            }
